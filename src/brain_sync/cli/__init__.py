...
def _resolve_root(args: argparse.Namespace) -> Path:
    """Resolve and validate the --root argument."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_run.add_argument("--root", type=Path, required=True, help="Brain root directory")

    # --- add ---
    p_add = sub.add_parser("add", help="Register a source URL for syncing")
    p_add.add_argument("--root", type=Path, required=True, help="Brain root directory")
    ...
    p_remove.add_argument("--root", type=Path, required=True, help="Brain root directory")
    ...
    p_list.add_argument("--root", type=Path, required=True, help="Brain root directory")
    ...
    p_move.add_argument("--root", type=Path, required=True, help="Brain root directory")
    ...
    p_status.add_argument("--root", type=Path, required=True, help="Brain root directory")

    # --- regen ---
    p_regen = sub.add_parser("regen", help="Manually trigger insight regeneration")
    p_regen.add_argument("--root", type=Path, required=True, help="Brain root directory")
    ...
    p_skill.add_argument("--root", type=Path, required=True, help="Brain root directory")
