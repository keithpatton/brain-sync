...
| `0.7.4` | `1.2` | `v30` | Supported same-format row |
| `0.7.5` | `1.2` | `v30` | Supported same-format row |
| `0.7.6` | `1.2` | `v30` | Current supported row |

Canonical compatibility statement:

`brain-sync 0.7.6 supports Brain Format 1.2 with runtime DB schema v30`
