...
This revision turns the surgical recommendations from
`docs/architecture/reviews/2026-03-18-review-2.md` into the next concrete
hardening pass. It is a plan for approval and execution readiness. It is not
...
The next required action is to review this revision against
`docs/plans/README.md` and either:

- create `plan_architecture-hardening_3_review_1_2026-03-18.md` if changes are required, or
- if acceptable, create the required approval artifact for this revision

Implementation must not begin until the corresponding approval artifact exists.
