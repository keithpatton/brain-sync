...
Approved: 2026-03-24T14-52-22
Approved by: codex-gpt-5

Notes:

- revision 2 resolves the four blockers from `plan_desktop-shell_review_1_2026-03-24.md`
- the desktop shell remains reuse-first, with one exact new orchestration surface and application-owned status/onboarding rules
- the `PySide6` decision is now bounded by import isolation, clear failure behavior, and non-desktop proof requirements
...
`docs/plans/plan_desktop-shell_2_2026-03-24.md` as the authoritative
