...
Approved: 2026-03-17T08-19-55
Approved by: Codex GPT-5

Notes:
- revision 2 closes the prior definition gap by explicitly defining portable state, real portable change, and excluded transport effects
- revision 2 narrows scope to the diagnosed insight-state seam and settles the previously open design/documentation decisions
