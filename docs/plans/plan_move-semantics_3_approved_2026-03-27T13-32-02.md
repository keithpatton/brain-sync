...
Approved: 2026-03-27T13-32-02
Approved by: Codex GPT-5

Notes:
- plan now chooses one exact phase-1 `move-path` surface and keeps source move semantics separate
- old-path cleanup is narrow, registration-aware, and explicit about journal preservation
- lease preflight, atomicity, rollback, and handled outcomes are specific enough for implementation and review
...
Approved copy for implementation handoff.

Source revision:

- `docs/plans/plan_move-semantics_3_2026-03-27.md`

This artifact is the authoritative approval handoff for implementation.
