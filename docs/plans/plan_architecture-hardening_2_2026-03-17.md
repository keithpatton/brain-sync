...
Plan revision 2. This artifact responds to
`docs/plans/plan_architecture-hardening_review_1_2026-03-17.md` and resolves
the blocking design choices that prevented approval of
`docs/plans/PLAN_architecture-hardening.md`.

This stage does **not** authorize implementation by itself. Work should follow
the normal `docs/plans/` review and approval trail.
...
Review 1 is the approval gate this revision must satisfy.
...
The next required action is to review this revision and either:

- create `plan_architecture-hardening_2_review_1_<date>.md`, or
- if acceptable, create the corresponding approval artifact per
