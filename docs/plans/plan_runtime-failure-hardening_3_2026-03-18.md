...
Plan revision 3. This artifact supersedes
`docs/plans/plan_runtime-failure-hardening_2_2026-03-18.md` for review
purposes and addresses the remaining issue raised in
`docs/plans/plan_runtime-failure-hardening_2_review_1_2026-03-18.md`.
